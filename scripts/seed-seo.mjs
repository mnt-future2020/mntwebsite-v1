...
const SITE = {
  siteName: "MnT Future — AI-Native, Agent-Ready Commerce",
...
const PAGES = [
  {
    path: "/",
    title: "MnT Future — AI-Native, Agent-Ready Commerce",
    description:
  ...
  {
    path: "/ai-agents",
    title: "AI & Agents for Commerce | MnT Future",
    description:
  ...
  },
  {
    ...
    title: "ADA, PCI DSS & Sales-Tax Compliance | MnT Future",
    description:
  ...
  },
  {
    ...
    description:
      "MnT Future (Magizh NexGen Technologies) builds AI-native, agent-ready commerce platforms for US D2C and marketplace brands. A senior team — land small, expand big.",
  },
  {
    path: "/contact",
    title: "Contact MnT Future — Free Architecture Workshop",
    description:

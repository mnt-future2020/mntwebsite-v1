...
function Card({ r }: { r: Receipt }) {
  return (
    ...
    >
      <span className="font-display text-[28px] font-bold leading-tight text-bp-ink">{r.value}</span>
      <span className="mt-2 flex-1 text-[13.5px] leading-[1.55] text-bp-mute">{r.label}</span>

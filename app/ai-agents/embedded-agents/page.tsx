...
export async function generateMetadata(): Promise<Metadata> {
  return resolveMetadata("/ai-agents/embedded-agents", {
    ...
    description:
      "Task-specific AI agents in your platform: support, merchandising, SEO/AEO, and inventory demand. Trained on your business, connected to your tools, with a human in control.",
  });
}
...
const config: ServiceConfig = {
  ...
  features: [
    { icon: "chat", title: "Customer support agent", desc: "Resolves common tickets end to end (order status, returns, product questions), resolving 70 to 90% on its own and handing the rest to your team with context." },

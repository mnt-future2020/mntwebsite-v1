...
export async function generateMetadata(): Promise<Metadata> {
  return resolveMetadata("/ai-agents/commerce-starter", {
    title: "AI Search & Recommendations for Commerce | MnT Future",
    description:
...
const config: ServiceConfig = {
  ...
  features: [
    { icon: "search", title: "AI search that understands meaning", desc: "Shoppers search in their own words, with typos, and still find the right products. Meaning, not just keywords." },

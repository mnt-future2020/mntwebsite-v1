...
const config: ServiceConfig = {
  ...
  features: [
    ...
    { icon: "cloud", title: "Production deployment & handover", desc: "Proper CI/CD, monitoring, and environments — deployed production-grade and handed over cleanly, fully documented." },

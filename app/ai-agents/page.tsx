...
const config: HubConfig = {
  ...
  heroChips: ["AI search & recs", "Agent-ready (ACP · UCP · MCP)", "Custom AI agents", "AI cleanup"],
  heroImage: images.ai,
  ...
  services: [
    { icon: "spark", title: "AI Search & Recommendations", desc: "Semantic search, personalized recommendations, and a conversational shopping assistant: turn the traffic you already have into revenue.", href: "/ai-agents/commerce-starter" },
    ...
    { icon: "chat", title: "Custom AI Agents", desc: "Task-specific agents (SEO/AEO, support, merchandising, analytics), domain-trained, MCP-connected, with human-in-the-loop oversight.", href: "/ai-agents/embedded-agents" },
  ...
  diff: {
    ...
    points: [
      ...
      "Embedded agents complete real work 24/7: support deflection of 70 to 90%, handle time from minutes to seconds.",
  ...
  stats: [
    ...
    { value: "70 to 90%", label: "Support deflection with agents" },
    { value: "$900B+", label: "Emerging agentic commerce channel" },
  ],
  faq: [
    { q: "Where should we start with AI?", a: "Almost always AI search and recommendations: semantic search, recommendations, and a shopping assistant convert your existing traffic and pay for themselves quickly. From there, agent-readiness and embedded agents expand the impact." },
    ...
    { q: "Is this just a chatbot?", a: "No. Custom AI agents are task-specific and connected to your tools via MCP: an SEO/AEO agent, a support agent, a merchandising agent, an inventory & demand agent: doing real work with human-in-the-loop oversight and evaluation gates." },

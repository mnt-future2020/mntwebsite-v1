...
const config: ServiceConfig = {
  ...
  heroSub:
    "AI shopping agents are becoming a $900B–$1T channel — and most stores can't transact in it. We make yours agent-ready: correct data, optimized feeds, real-time sync, and the ACP, UCP and MCP integrations agents use to buy.",
  heroImage: images.ai,

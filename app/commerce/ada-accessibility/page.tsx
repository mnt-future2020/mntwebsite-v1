...
export async function generateMetadata(): Promise<Metadata> {
  return resolveMetadata("/commerce/ada-accessibility", {
    ...
    description:
      "78% of accessibility lawsuits target e-commerce. We bring your store to WCAG conformance and keep it there as it changes: lower risk, more shoppers served.",
  });
}
...
const config: ServiceConfig = {
  ...
  heroSub:
    "Roughly 78% of accessibility lawsuits target e-commerce, and the demand letters don't warn first. We bring your store to WCAG conformance and keep it there as the store changes: lower legal risk, and more shoppers who can actually buy.",
  heroImage: images.dev,
  chips: ["WCAG 2.2 AA", "Screen readers & keyboard", "Stays conformant", "Audit & fix, then upkeep"],
  ...
  intro: {
    ...
    body: (
      <>
        ...
        store conformant as products, pages, and campaigns change: because accessibility isn't a
  ...
  features: [
    ...
    { icon: "clock", title: "Conformance upkeep", desc: "New pages, products, and campaigns are checked as they ship, so conformance survives change." },
  ...
  approachPoints: [
    ...
    "Conformance maintained continuously as the store changes, not re-earned in a panic.",
  ...
  faq: [
    ...
    { q: "Do accessibility overlay widgets work?", a: "They don't fix the underlying code, and stores using them still get sued. We build conformance into the product itself: markup, focus, contrast, and flows, which is what the standard actually measures." },
    { q: "What standard do you build to?", a: "WCAG 2.2 AA: the level courts and auditors reference. We audit against it, fix to it, and keep you conformant against it as the store changes." },
    ...
    { q: "Is this one-time or ongoing?", a: "Both exist, honestly: an audit-and-fix project gets you conformant, and the managed SLA keeps you there as products and campaigns change. A store that ships weekly needs the second." },
  ],
  cta: {
    title: "Get conformant before the letter arrives.",

...
const config: ServiceConfig = {
  ...
  features: [
    { icon: "store", title: "D2C / Brand Stores", desc: "Your own brand selling direct to your own customers: a single-seller storefront built for fashion, beauty, food, and D2C startups.", href: "/commerce/d2c-brand-stores" },
    { icon: "network", title: "Marketplace Platforms", desc: "Multiple sellers selling on one platform you own, the way Amazon or Etsy works: seller onboarding, commissions, and split payments built in.", href: "/commerce/marketplace-platforms" },
    { icon: "users", title: "Multi-Vendor Stores", desc: "A marketplace at a smaller scale: local vendors, community sellers, or a single-category platform with the same seller tools, sized for a focused market.", href: "/commerce/multi-vendor-stores" },
    { icon: "building", title: "B2B Commerce", desc: "Wholesale and dealer or distributor portals: customer-specific pricing and catalogs, bulk ordering, net terms, and credit limits.", href: "/commerce/b2b-wholesale" },
    { icon: "clock", title: "Subscription Commerce", desc: "Recurring orders for boxes, meal kits, refills, and memberships: auto-billing, pause and skip, and renewal management built in.", href: "/commerce/subscription-commerce" },
    { icon: "bolt", title: "Quick Commerce / Hyperlocal", desc: "Fast, location-based delivery for grocery, food, and pharmacy: delivery zones, live order tracking, and real-time stock by location.", href: "/commerce/quick-commerce" },
    { icon: "phone", title: "Mobile Commerce Apps", desc: "Native iOS and Android apps for any of the models above, built with React Native or Flutter to load fast and convert on every device.", href: "/commerce/mobile-commerce-apps" },
  ],
